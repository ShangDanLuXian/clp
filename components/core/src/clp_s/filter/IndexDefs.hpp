 ...
 * expected to grow as indexes are added.
 */
...
// First Index ID reserved for official open-source indexes.
constexpr index_id_t cOfficialOpenSourceIndexIdBegin{0x0000};

// First Index ID reserved for official closed-source indexes.
