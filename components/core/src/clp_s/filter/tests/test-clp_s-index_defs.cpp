...
TEST_CASE("index-defs-index-version-round-trip", "[clp_s][indexing]") {
...
TEST_CASE("index-defs-classify-index-id", "[clp_s][indexing]") {
...
TEST_CASE("index-defs-archive-section-bitmap", "[clp_s][indexing]") {
